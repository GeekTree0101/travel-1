    ...
    public String strategySave(HttpServletRequest request, String id, @RequestParam("fileName1") MultipartFile file1,
        ...
        try {
            ...
            if(file1!= null && !file1.isEmpty()){
                ...
                String path = "C:\\Users\\Administrator\\Desktop\\travel-master\\src\\main\\resources\\static\\images" ;
                ...
                try {
                    ...
                    entity.setImgUrl("/images/" + fileName);
            ...
            if(file2!= null && !file2.isEmpty()){
                ...
                try {
                    ...
                    entity.setIntroUrl("/images/" + fileName);
                } catch (IllegalStateException e) {
                    e.printStackTrace();
                } catch (IOException e) {
                    // TODO Auto-generated catch block
